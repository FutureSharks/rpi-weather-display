...
class owmWeather(object):
    ...
    def update_forcast(self):
        ...
        Refreshes forecast
        '''
        if not hasattr(self, 'one_call') or time.time() - self.one_call.current.to_dict()['reference_time'] > 300:
    ...
    def get_current_weather(self):
        ...
        current = {
            ...
            'temperature_feels_like': self.one_call.current.temperature('celsius')['feels_like'],
