...
def create_forecast_image(hourly_plot, daily_text, current_text, width=1448, height=1072, rotate=0, font_path=None):
    ...
    d.text((10, 10), "W e a t h e r   NOW!", font=ImageFont.truetype(font_path, 40), fill=0)
    d.text((10,70), current_text, font=ImageFont.truetype(font_path, 30), fill=0)

    # Daily
    indent = 10
    d.text((10, 270), "W e a t h e r   FUTURE!", font=ImageFont.truetype(font_path, 40), fill=0)
